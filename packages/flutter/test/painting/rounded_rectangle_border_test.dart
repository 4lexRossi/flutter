...
void main() {
  ...
  test('RoundedRectangleBorder', () {
    const RoundedRectangleBorder c10 =
        RoundedRectangleBorder(side: BorderSide(width: 10.0));
    const RoundedRectangleBorder c15 =
        RoundedRectangleBorder(side: BorderSide(width: 15.0));
    const RoundedRectangleBorder c20 =
    ...
    const RoundedRectangleBorder c1 =
        RoundedRectangleBorder(side: BorderSide());
    const RoundedRectangleBorder c2 =
        RoundedRectangleBorder(side: BorderSide());
