...
void main() {
  ...
  test('ContinuousRectangleBorder scale and lerp', () {
    const ContinuousRectangleBorder c10 =
        ContinuousRectangleBorder(side: BorderSide(width: 10.0));
    const ContinuousRectangleBorder c15 =
        ContinuousRectangleBorder(side: BorderSide(width: 15.0));
    const ContinuousRectangleBorder c20 =
        ContinuousRectangleBorder(side: BorderSide(width: 20.0));
