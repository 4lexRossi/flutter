...
void main() {
  ...
  testWidgets('LinearProgressIndicator custom minHeight',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Theme(
        data: theme,
  ...
  testWidgets('CircularProgressIndicator stroke width',
      (WidgetTester tester) async {
    await tester.pumpWidget(
  ...
  testWidgets('CircularProgressIndicator strokeAlign',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Theme(
        data: theme,
  ...
  testWidgets('CircularProgressIndicator with strokeCap',
      (WidgetTester tester) async {
    ...
    expect(find.byType(CircularProgressIndicator),
        paints..arc(strokeCap: StrokeCap.butt),
        reason:
            'strokeCap can be set to StrokeCap.butt, and will not be overridden.');
  ...
  testWidgets('LinearProgressIndicator with indicatorBorderRadius',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Theme(
        data: theme,
  ...
  testWidgets('CircularProgressIndicator paint colors',
      (WidgetTester tester) async {
  ...
  testWidgets('RefreshProgressIndicator with a round indicator',
      (WidgetTester tester) async {
  ...
  testWidgets('LinearProgressIndicator with height 12.0',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Theme(
        data: theme,
  ...
  testWidgets('LinearProgressIndicator with default height',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Theme(
        data: theme,
  ...
  testWidgets('LinearProgressIndicator can be made accessible',
      (WidgetTester tester) async {
    final SemanticsHandle handle = tester.ensureSemantics();
  ...
  testWidgets('CircularProgressIndicator can be made accessible',
      (WidgetTester tester) async {
    final SemanticsHandle handle = tester.ensureSemantics();
    final GlobalKey key = GlobalKey();
    const String label = 'Label';
  ...
  testWidgets('RefreshProgressIndicator can be made accessible',
      (WidgetTester tester) async {
    final SemanticsHandle handle = tester.ensureSemantics();
    final GlobalKey key = GlobalKey();
    const String label = 'Label';
  ...
  testWidgets('default size of CircularProgressIndicator is 36x36 - M3',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('RefreshProgressIndicator using fields correctly',
      (WidgetTester tester) async {
