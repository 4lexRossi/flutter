...
void main() {
  ...
  testWidgets('Material2 - SwitchListTile has the right colors',
  ...
  testWidgets('Material3 - SwitchListTile has the right colors',
      (WidgetTester tester) async {
    bool value = false;
    await tester.pumpWidget(
      MediaQuery(
  ...
  testWidgets('SwitchListTile.adaptive only uses material switch',
      (WidgetTester tester) async {
    bool value = false;
  ...
  testWidgets('SwitchListTile controlAffinity test',
    ...
    final ExcludeFocus excludeFocusWidget = tester.widget(
      find.byWidgetPredicate((Widget widget) =>
          listTile.leading == widget && widget is ExcludeFocus),
    );
  ...
  testWidgets('SwitchListTile controlAffinity default value test',
    ...
    final ExcludeFocus excludeFocusWidget = tester.widget(
      find.byWidgetPredicate((Widget widget) =>
          listTile.trailing == widget && widget is ExcludeFocus),
    );
  ...
  testWidgets('SwitchListTile respects trackColor in hovered states',
      (WidgetTester tester) async {
    tester.binding.focusManager.highlightStrategy =
        FocusHighlightStrategy.alwaysTraditional;
  ...
  testWidgets('SwitchListTile respects thumbIcon - M3',
      (WidgetTester tester) async {
