...
void main() {
  ...
  group('CalendarDatePicker', () {
    ...
    testWidgets('Can select a day with nothing first selected',
    ...
    testWidgets('Can select a month with nothing first selected',
        (WidgetTester tester) async {
      DateTime? displayedMonth;
      await tester.pumpWidget(calendarDatePicker(
        onDisplayedMonthChanged: (DateTime date) => displayedMonth = date,
    ...
    testWidgets('Can select a year with nothing first selected',
        (WidgetTester tester) async {
      DateTime? displayedMonth;
      await tester.pumpWidget(calendarDatePicker(
        onDisplayedMonthChanged: (DateTime date) => displayedMonth = date,
    ...
    testWidgets('Material2 - currentDate is highlighted',
        (WidgetTester tester) async {
      await tester.pumpWidget(calendarDatePicker(
        useMaterial3: false,
        initialDate: DateTime(2016, DateTime.january, 15),
    ...
    testWidgets('Material3 - currentDate is highlighted',
        (WidgetTester tester) async {
      await tester.pumpWidget(calendarDatePicker(
        useMaterial3: true,
        initialDate: DateTime(2016, DateTime.january, 15),
    ...
    group('Haptic feedback', () {
      ...
      testWidgets('Changing modes and year vibrates',
          (WidgetTester tester) async {
        await tester.pumpWidget(calendarDatePicker(
          initialDate: DateTime(2016, DateTime.january, 15),
        ));
  ...
  group('YearPicker', () {
    ...
    testWidgets('Selecting year with no selected month uses January',
        (WidgetTester tester) async {
      DateTime? selectedYear;
      await tester.pumpWidget(yearPicker(
        firstDate: DateTime(2018, DateTime.june, 9),
