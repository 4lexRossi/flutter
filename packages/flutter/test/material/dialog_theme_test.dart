...
void main() {
  test('DialogTheme copyWith, ==, hashCode basics', () {
    ...
    expect(
        const DialogTheme().hashCode, const DialogTheme().copyWith().hashCode);
  });
  ...
  testWidgets('Material3 - Custom dialog shape matches golden',
      (WidgetTester tester) async {
    const RoundedRectangleBorder customBorder = RoundedRectangleBorder();
    const AlertDialog dialog = AlertDialog(
      title: Text('Title'),
  ...
  testWidgets('Material2 - Custom dialog shape matches golden',
      (WidgetTester tester) async {
    const RoundedRectangleBorder customBorder = RoundedRectangleBorder();
    const AlertDialog dialog = AlertDialog(
      title: Text('Title'),
  ...
  testWidgets('Material3 - Custom Title Text Style - Theme',
      (WidgetTester tester) async {
    const String titleText = 'Title';
    const TextStyle titleTextStyle = TextStyle(color: Colors.pink);
  ...
  testWidgets('Material2 - Custom Title Text Style - Theme',
      (WidgetTester tester) async {
    const String titleText = 'Title';
    const TextStyle titleTextStyle = TextStyle(color: Colors.pink);
    const AlertDialog dialog = AlertDialog(title: Text(titleText));
  ...
  testWidgets('Simple Dialog - Custom Title Text Style - Theme',
      (WidgetTester tester) async {
    const String titleText = 'Title';
    const TextStyle titleTextStyle = TextStyle(color: Colors.pink);
    const SimpleDialog dialog = SimpleDialog(
  ...
  testWidgets('Material3 - Custom Content Text Style - Theme',
      (WidgetTester tester) async {
    const String contentText = 'Content';
    const TextStyle contentTextStyle = TextStyle(color: Colors.pink);
    const AlertDialog dialog = AlertDialog(
  ...
  testWidgets('Material2 - Custom Content Text Style - Theme',
      (WidgetTester tester) async {
    const String contentText = 'Content';
    const TextStyle contentTextStyle = TextStyle(color: Colors.pink);
  ...
  testWidgets('Custom barrierColor - Theme', (WidgetTester tester) async {
    ...
    const SimpleDialog dialog = SimpleDialog();
    final ThemeData theme =
        ThemeData(dialogTheme: const DialogTheme(barrierColor: barrierColor));
  ...
  testWidgets('DialogTheme.insetPadding updates Dialog insetPadding',
      (WidgetTester tester) async {
    // The default testing screen (800, 600)
    const Rect screenRect = Rect.fromLTRB(0.0, 0.0, 800.0, 600.0);
    const DialogTheme dialogTheme =
        DialogTheme(insetPadding: EdgeInsets.fromLTRB(10, 15, 20, 25));
