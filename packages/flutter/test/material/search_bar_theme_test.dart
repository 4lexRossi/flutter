...
void main() {
  ...
  testWidgets('SearchBarThemeData implements debugFillProperties',
    ...
    expect(description[2],
        'shadowColor: WidgetStatePropertyAll(Color(0xfffffff2))');
    expect(description[3],
        'surfaceTintColor: WidgetStatePropertyAll(Color(0xfffffff3))');
    expect(description[4],
        'overlayColor: WidgetStatePropertyAll(Color(0xfffffff4))');
    expect(description[5],
        'side: WidgetStatePropertyAll(BorderSide(color: Color(0xfffffff5), width: 2.0))');
  ...
  group('[Theme, SearchBarTheme, SearchBar properties overrides]', () {
    ...
    const OutlinedBorder shapeValue = RoundedRectangleBorder(side: sideValue);
