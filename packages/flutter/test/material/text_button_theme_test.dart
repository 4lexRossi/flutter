...
void main() {
  ...
  group('[Theme, TextTheme, TextButton style overrides]', () {
    ...
    const OutlinedBorder shape = RoundedRectangleBorder(side: side);
    ...
    void checkButton(WidgetTester tester) {
      ...
      expect(
          find.descendant(
              of: findMaterial, matching: find.byKey(backgroundKey)),
          findsOneWidget);
      expect(
          find.descendant(of: findInkWell, matching: find.byKey(foregroundKey)),
          findsOneWidget);
    }
