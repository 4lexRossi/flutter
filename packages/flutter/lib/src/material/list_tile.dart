...
class _RenderListTile extends RenderBox
  ...
  void performLayout() {
    ...
    double? subtitleY;
    if (!hasSubtitle) {
      tileHeight = math.max(minTileHeight ?? _defaultTileHeight,
    ...
    final (double leadingY, double trailingY) = switch (titleAlignment) {
      ListTileTitleAlignment.threeLine when isThreeLine => (
          _minVerticalPadding,
          _minVerticalPadding
        ),
      ListTileTitleAlignment.threeLine => (
      ...
      ListTileTitleAlignment.bottom => (
          leadingDiff - _minVerticalPadding,
          trailingDiff - _minVerticalPadding
        ),
    };
